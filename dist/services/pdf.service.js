...
function textH(doc, str, font, size, w, lineGap = 0) {
...
function card(doc, x, y, w, h, opts = {}) {
    ...
    if (opts.accent)
        doc.rect(x, y + 4, 3, h - 8).fill(opts.accent);
    doc.restore();
}
function bar(doc, x, y, w, h, pct, color) {
    ...
    if (pct > 0)
        doc.roundedRect(x, y, Math.max(w * (pct / 100), h), h, h / 2).fill(color);
    doc.restore();
}
...
// ============================================================================
function renderRealityCheck(doc, r) {
...
// ============================================================================
function renderScorecard(doc, r) {
...
// ============================================================================
function renderSalesModel(doc, r) {
...
// 05 — Competitors
// ============================================================================
function renderCompetitors(doc, r) {
...
// ============================================================================
function renderPositioning(doc, r) {
...
// ============================================================================
function renderBottomLine(doc, r) {
...
// ============================================================================
function renderRecommendations(doc, r) {
