...
exports.buildReportEmailHtml = buildReportEmailHtml;
...
function stageConfig(stage) {
    ...
    if (s.includes('strong'))
        return { label: 'Strong PMF', color: '#059669', bg: '#ecfdf5' };
    if (s.includes('early'))
        return { label: 'Early PMF', color: '#0891b2', bg: '#ecfeff' };
    if (s.includes('good') || s.includes('solid'))
        return { label: 'Solid PMF', color: '#047857', bg: '#ecfdf5' };
    if (s.includes('approach') || s.includes('emerging') || s.includes('moderate'))
        return { label: 'Approaching', color: '#d97706', bg: '#fffbeb' };
